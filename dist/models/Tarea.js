...
class Tarea {
    ...
    static importarTarea(json) {
        // Creamos la instancia de Tarea
        const tarea = new Tarea(json.titulo, json.descripcion, json.dificultad, json.fechaVencimiento ? new Date(json.fechaVencimiento) : undefined);
